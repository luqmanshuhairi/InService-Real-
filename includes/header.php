...
<div class="header">
  <div class="shimmer">
  <b style="font-size: 30px; line-height: 30px;"><span class="material-icons">shopping_cart</span>&ensp;InService</b>
  </div>
</div>
...
<nav class="navi">
  <ul style="margin-top: 0%; padding: 0; list-style-type: none;">
    ...
    <li id="store" onclick="location.replace('contact_form.html')"><span class="material-icons md-48 md-light">help</span></li>
    ...
    <li id="transaction" onclick="location.replace('orderhistory.html')"><span class="material-icons md-48 md-light">paid</span></li>
