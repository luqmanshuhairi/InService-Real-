        ...
        if($res2->num_rows>0)
        {
            ...
            while($rows2=$res2->fetch_assoc())
            {
                ...
                <div class='card'>
                    ...
                    <br><br><br>
                    <a href='cust_book_det.php?id={$rows2["bid"]}'><button class='custom-btn btn'>View Item</button></a>
                    </div>
                </div>
        ...
        if($res3->num_rows>0)
        {
            ...
            while($rows3=$res3->fetch_assoc())
            {
                ...
                <div class='card'>
                    ...
                    <a href='cust_book_det.php?id={$rows3['bid']}'><button class='custom-btn btn'>View Item</button></a>
                </div>
                </div>            
                ";
            }
